Feature: Managing book creation and retrieval
    ...
    Scenario: Reserve a book and check that it has been reserved
        When the user reserve a book "1984" authored by "George Orwell"
        The book should be reserved and not yet bookable